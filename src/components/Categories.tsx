...
export default function Categories({
  ...
  const settings = {
    ...
    responsive: [
      {
        breakpoint: 1280, // Large screens / standard desktops
        settings: {
          slidesToShow: 3.5,
          slidesToScroll: 1,
        },
  ...
  return (
    <section className="bg-surface-low/50 w-full flex justify-center border-b border-outline-variant/10 overflow-hidden" id={id}>
      <div className="w-full inner-wrap">

        {/* Title container - standard container width */}
        ...
        {/* Slider wrapper - Bleeds off the right edge of the viewport, aligns with container on the left */}
